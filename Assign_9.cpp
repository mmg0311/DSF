...
void with :: display(){
	cout <<  "Index" << setw(20) << "Name" << setw(20) <<"Phone number" << setw(20) << "link" << endl;
	for(int i=0;i<max;i++){
		cout<< setw(30) << setiosflags(ios::left) <<i << setw(30) << setiosflags(ios::left) << h[i].name << setw(30) << setiosflags(ios::left)  << h[i].p << setw(30) << setiosflags(ios::left) << h[i].link << endl;
	}
}
...
void without :: display(){
	cout <<"Index"  << setw(20) << "Name" << setw(20)<< "Phone number" << setw(20) << "link" << endl;
	for(int i=0;i<max;i++){
		cout<< i << setw(30)  << h[i].name << setw(30)<< h[i].p << setw(30) << h[i].link << endl;
	}
}
